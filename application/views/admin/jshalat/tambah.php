    ...
    <div class="content-header">
      ...
      <div class="container-fluid">
			...
			//Notofikasi Error
				...
				//form open
				echo form_open_multipart(base_url('admin/jshalat/tambah'), ' class="form_horizontal"');
				 ?>
					 <div class="card">
            			<div class="card-header">
							...
							<div class="form-group row">
								...
								<div class="col-md-5">
								  <input type="time" name="waktu" class="form-control"  placeholder="Waktu Kajian" value="<?php echo set_value('waktu') ?>" required>
								</div>
							</div>
